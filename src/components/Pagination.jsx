    ...
    return (
        ...
        pages > 1 && (
            ...
            <div className="pagination">
                ...
                {/* {middlePagination} */}
                <div className='bg-red-400 px-4 font-bold text-white flex justify-center items-center rounded-full'>
                    <span contentEditable onChange={(e) => setPage(e.target.value)}>
                        {page}
                    </span>
                    /{pages}
                </div>
